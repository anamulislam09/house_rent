...
@section('admin_content')
                            ...
                            <div class="card-header bg-primary">
                                <div class="row ">
                                    <div class="col-lg-10 col-sm-12">
                                        <h3 class="card-title text" style="width:100%; text-align:center">Monthly Bills
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody id="billsTable">
                                            @foreach ($bills as $key => $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{ number_format($total_collection_amount , 2) }}</td>
    ...
    <script>
        $('body').on('click', '.edit', function() {
            ...
            $.get("/admin/bills/report-details/" + tenant_id + "/" + bill_setup_date, function(data) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#filterButton').on('click', function() {
                ...
                $.ajax({
                    url: `/admin/bills/report-filter/${tenantId}/${date}`,
                    method: 'GET',
                            ...
                            response.forEach((bill, index) => {
                                ...
                                $('tbody').append(`
                                    <tr>
                                        ...
                                        <td class="text-right">${parseFloat(bill.total_collection_amount).toFixed(2)}</td>
                                        <td class="text-center">
                                            <a href="#" class="btn btn-sm btn-info edit"
