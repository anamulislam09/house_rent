...
@section('admin_content')
    ...
    {{-- category edit model --}}
    <!-- Modal -->
    <div class="modal fade" id="editAgreement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <script>
        $('body').on('click', '.edit', function() {
            let agreement_id = $(this).data('id');
            $.get("/admin/rental-agreement/edit/" + agreement_id, function(data) {
